...
// it looks to see if the actor's name is Andrew Garfield and changes the actor object to have a property
// called spiderRating with a value of 10.  If their name is Tobey Maguire set spiderRating to 0. 
// otherwise set spiderRating to 'not a spiderman'.
...
// #15 Create a function called whatIsItOutside that takes in a temperature (number),
...
*/
function whatIsItOutside(temp,humid,cloud){
  if (temp > 85 && humid > 45){
    return "I'm all sweat"
  } else if(temp < 40 && cloud > 60){
    return "I have icicles"
  } else if (temp > 85 && cloud < 20 && humid < 45){
    return "I'm literally in the desert"
  } else if (temp > 90 || humid > 55 || cloud > 65){
...
//invokes it(holla) with the string(back) + ' back'.
